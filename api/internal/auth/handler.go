...
// @Description Verifies the Supabase access token from the magic link callback, sets portal JWT cookies, and returns ok.
// @Tags        auth
// @Accept      json
// @Produce     json
...
// @Description Uses the refresh_token HTTP-only cookie to issue a new access_token cookie.
// @Tags        auth
// @Produce     json
// @Success     200 {object} utils.OKResponse
// @Failure     401 {object} utils.ErrorResponse
